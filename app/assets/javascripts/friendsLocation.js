...
// var userLocation = userLocation();
	...
	if (window.location.pathname.indexOf("/friends/", 0) == 0) {
		...
		$.ajax({
			...
			success: function(response) {
				...
				friendsCompass.bearing = response.bearing;
				friendsCompass.distance = response.distance;
				friendsCompass.lat = response.coords.user_lat;
				friendsCompass.lng = response.coords.user_lng;
	...
	friendsCompass.userLocation = function() {
